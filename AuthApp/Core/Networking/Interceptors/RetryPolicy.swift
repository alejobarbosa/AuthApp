...
public struct RetryPolicy: Sendable {
    ...
    public static let `default` = RetryPolicy(maxAttempts: 3, baseDelayMilliseconds: 300) { error in
    ...
    public static let noRetry = RetryPolicy(maxAttempts: 1, baseDelayMilliseconds: 0) { _ in false }
